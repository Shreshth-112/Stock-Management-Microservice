...
public class DispatchController {
	...
	public Dispatch addDispatcher(@RequestBody Dispatch dispatch) {
	...
	// find by id
	@GetMapping("/byid/{id}")
	public Dispatch DispatcherById(@PathVariable Long id) {
		return service.getDispatcherById(id);
	}
	
	// find by Address
	@GetMapping("/byaddress/{address}")
	public List<Dispatch> DispatcherByAddress(@PathVariable String address){
