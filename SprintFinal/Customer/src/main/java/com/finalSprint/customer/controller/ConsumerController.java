...
public class ConsumerController {
	...
	public Customer getProduct(@PathVariable long id) {// throws InvalidValueException{
		return service.findCustomerById(id);
	}

	@DeleteMapping("/customerdeletebyid/{id}")
	public void deleteCustomerData(@PathVariable long id) {// throws InvalidValueException{
