...
public class DispatcherController {
	...
	public Dispatcher addDispatcher(@RequestBody Dispatcher dispatch) {
	...
	// find by id
	@GetMapping("/byid/{id}")
	public Dispatcher DispatcherById(@PathVariable Long id) {
		return dispatcherService.getDispatcherById(id);
	}
	
	// find by Address
	@GetMapping("/byaddress/{address}")
	public List<Dispatcher> DispatcherByAddress(@PathVariable String address){
	...
	public ResponseEntity<Dispatcher> update(@PathVariable long id, @RequestBody Dispatcher dispatch) {
