...
public class CustomerService {
	...
	public Customer saveCustomer(Customer c) throws InvalidValueException, Exception {
		  ...
		  if(c.getCustomerName()==null | c.getCustomerLocation()==null |
		  c.getProductName()==null |c.getQuantity()==null) { throw new
		  NullPointerException("Please enter the Customer details"); }
